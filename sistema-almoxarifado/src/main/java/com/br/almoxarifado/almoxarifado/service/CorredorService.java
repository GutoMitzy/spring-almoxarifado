...
public class CorredorService {
    ...
    public Page<CorredorModel> findCorredorBySetorPage(String setor, Integer page, Integer size) {
        return corredorRepository.findBySetor(setor, PageRequest.of(page, size));
    }
