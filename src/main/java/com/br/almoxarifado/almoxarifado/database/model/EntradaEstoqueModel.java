...
public class EntradaEstoqueModel {
    ...
    @OneToMany
    @JoinColumn(name = "entrada_item_id")
    private List<EntradaItemModel> itens;

    public EntradaEstoqueModel(EntradaEstoqueDto data, EmpresaModel fornecedor, List<EntradaItemModel> itens) {
